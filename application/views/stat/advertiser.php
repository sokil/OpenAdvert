...
$this->pageTitle = $advertiser->getName();
...
<div class="row-fluid">
    <div class="col-md-2" id="menu">
        <div class="panel panel-default">
            <div class="panel-heading"><?php echo _('Events'); ?></div>
            <div class="list-group">
                <a href="#stat/campaigns?advertiser=<?php echo $advertiser->getId(); ?>" class="list-group-item"><?php echo _('Campaigns'); ?></a>
            </div>
        </div>
    </div>
    <div class="col-md-10">
